			...
			<div class="row">
				<div class="col-lg-12 col-sm-12 text-center">
					<div class="main-menu-wrap">
						...
						<nav class="main-menu">
							<ul>
								<li class="current-list-item"><a href="<?php echo base_url('pembeli/home') ?>">Home</a>
				...
				<div class="col-lg-9 offset-lg-2 text-center">
					<div class="hero-text">
						<div class="hero-text-tablecell">
							<p class="subtitle">Fresh & Nice</p>
							<h1>Delicious Seasonal Foods</h1>
							<div class="hero-btns">
								<a href="<?php echo base_url('pembeli/order') ?>" class="boxed-btn">Food Collection</a>
								<a href="<?php echo base_url('pembeli/kontak') ?>" class="bordered-btn">Contact Us</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						<div class="product-image">
							<a href="<?php echo base_url('pembeli/home/pesan/'.$s->id_produk);?>"><img src="<?php echo base_url();?>upload/foto/<?php echo $s->foto;?>" width="300" height="300" alt=""></a>
						</div>
						<h3><?php echo $s->nama_produk?></h3>
						<p class="product-price">RP.<?php echo $s->harga_produk?></p>
						<p><?php echo $s->deskripsi?></p>
						<form class="form-horizontal" action="<?php echo base_url('pembeli/home/tambah'); ?>" method="post" enctype="multipart/form-data">
